...
There are things all language servers have in common, like storing the current environment configuration, updating it on file changes, renaming, or navigating to a symbol's definition. 
I tried to automate some of those scenarios or provide a flexible mechanism to adjust the behavior of a language server.
