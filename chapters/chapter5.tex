...
Every type class method carries a default returning a neutral value, so the only strictly mandatory inputs are \texttt{fileExtension} and \texttt{buildAsts} in \texttt{LSConfiguration}.
