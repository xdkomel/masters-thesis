...
Two unrelated languages were served without modifying any core module, confirming that the \texttt{binder}/\texttt{sig} parameterization achieves genuine language agnosticism.
Flan exercises the full feature set and shows what a complete integration looks like; LambdaPi provides only syntax highlighting, relying on no-op defaults for everything else, and shows how little is required to reach a first running state.
