...
The goal of this work is to develop an out-of-box solution for a minimal language server. 
Given a Foil AST and some signature-dependant functions, it has to compile into a binary communicating via LSP. 
The work also provides a small example project demonstrating the integration of such a language server into the Visual Studio Code (VS Code) \footnote{\url{https://code.visualstudio.com/}}, an open-source code editor.
